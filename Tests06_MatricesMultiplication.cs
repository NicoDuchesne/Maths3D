...
public class Tests06_MatricesMultiplication
{
    ...
    public void TestImpossibleMultiplication()
    {
        ...
        ClassicAssert.Throws<MatrixMultiplyException>(() => { m1.Multiply(m2); });
    
        ClassicAssert.Throws<MatrixMultiplyException>(() => { Matrix<int>.Multiply(m1, m2); });
    
        ClassicAssert.Throws<MatrixMultiplyException>(() =>
        {
            Matrix<int> m3 = m1 * m2;
        });
    }
